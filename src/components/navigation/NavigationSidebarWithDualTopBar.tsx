...
export function NavigationSidebarWithDualTopBar({
  onActiveItemChange,
  ...
  const getFirstItemInCategory = (categoryId: string) => {
    const settingsSubItems: Record<string, Array<{ id: string; label: string }>> = {
      ...
      'orders-billing': [
        { id: 'add-new-vehicles', label: 'Add New Vehicles' },
        { id: 'view-orders', label: 'View Orders' },
        { id: 'subscriptions', label: 'Subscriptions' },
      ],
      'api-resources': [
        { id: 'api-documentation', label: 'API Documentation' },
        { id: 'request-api-access', label: 'Request API Access' },
      ],
      'import-wizard': [
        { id: 'import-services', label: 'Import Services' },
        { id: 'import-drivers', label: 'Import Drivers' },
        { id: 'import-purchases', label: 'Import Purchases' },
      ],
    };
  ...
  return (
    <div className="w-full h-screen flex flex-col">
      {/* Primary Top Bar */}
      <div className="h-14 bg-white border-b border-gray-200 flex items-center justify-between px-4 relative z-30">
        ...
        {/* Right side - Settings Categories, Messages, Notifications, User Avatar */}
        <div className="flex items-center space-x-1">
          {/* Settings Categories Menu */}
          <SettingsCategoriesMenu
            onCategoryClick={handleSettingsCategoryClick}
